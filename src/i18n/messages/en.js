...
export default {
  ...
  orderPartiallyFilledSell: 'Order #{0} partially filled: {1} sell {2}',
  orderFilledSell: 'Order #{0} filled: {1} sell {2}',
  orderPartiallyFilledBuy: 'Order #{0} partially filled: {1} buy {2}',
  orderFilledBuy: 'Order #{0} filled: {1} buy {2}',
