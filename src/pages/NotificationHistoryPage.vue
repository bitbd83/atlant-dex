      ...
      table.table__body
        thead
          tr.notificationHistory__row
            //- th
            th.table__sortable(:class="{'table__sortable--desc': sortBy==='datetime' && !asc}" @click="sortNotifications('datetime')") {{$t('pages.time_date')}}
            th.table__sortable(:class="{'table__sortable--desc': sortBy==='level' && !asc}" @click="sortNotifications('level')") {{$t('pages.type')}}
